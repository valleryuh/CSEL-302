...
Example:
model classroom_simulation   ![alt text](1.png)
...
species student {
   ...
   int energy <- 5;
   int score <- 0;
   string status <- "active";  ![alt text](2.png)
...
global {
   ...
   init {
      create student number: 20;   ![alt text](5.png)
   }

}
# Part 7 – Step 6: Run the Simulation
![alt text](11.png) ![alt text](22.png)
